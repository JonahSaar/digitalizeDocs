...
def find_date(text):
    ...
    date_list += list(dict.fromkeys(search_date(dd_mm_yyyy_pattern2, text, text)))
    date_list += list(dict.fromkeys(search_date(yyyy_mm_dd_pattern, text, text)))
    date_list += list(dict.fromkeys(search_date(yyyy_mm_dd_pattern2, text, text)))
